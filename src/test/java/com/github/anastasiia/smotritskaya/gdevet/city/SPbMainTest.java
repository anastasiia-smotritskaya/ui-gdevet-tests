...
import com.github.anastasiia.smotritskaya.gdevet.base.SPbBaseTest;
...
import static com.github.anastasiia.smotritskaya.gdevet.pages.factory.City.SPB;
import static com.github.anastasiia.smotritskaya.gdevet.pages.factory.PageFactory.createMainPage;
import static com.github.anastasiia.smotritskaya.gdevet.pages.factory.PageFactory.createVetklinikiPage;
...
public class SPbMainTest extends SPbBaseTest {
    ...
    private static final int NUMBER_OF_SERVICES_NOT_HIDEABLE = 34;
    private static final Map<String, String> notHideableMap = new HashMap<>();
    private static final List<String> notHideableList = new ArrayList<>();

    private static final int NUMBER_OF_SERVICES_HIDEABLE = 65;
    private static final Map<String, String> hideableMap = new HashMap<>();
    private static final List<String> hideableList = new ArrayList<>();
