...
import static com.codeborne.selenide.Selenide.$$;
import static com.github.anastasiia.smotritskaya.gdevet.utils.ExpectedText.*;
...
public class SPbMainPage extends SPbBasePage {
    ...
    public final ElementsCollection uslugi_not_hideable = $$(byXpath("//*[@class='sibling ']" +
            "//*[@class='list-title']"));
    public final ElementsCollection uslugi_hideable = $$(byXpath("//*[@class='sibling hideable']" +
            "//*[@class='list-title']"));
    public final ElementsCollection uslugi_title = $$(byXpath("//*[@class='title']" +
            "//*[@class='list-title']"));
}
